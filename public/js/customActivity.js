    ...
    async function lookupPromos(fuel2Token) {
        ...
        try {
            ...
            for (i = 0; i < result.items.length; ++i) {
                ...
                $("#instore_code_1").append(`<option data-attribute-loyalty="${result.items[i].values.optimainstantwin}" data-attribute-validfrom="${result.items[i].values.datefrom}" data-attribute-validto="${result.items[i].values.dateto}" data-attribute-discountid="${result.items[i].keys.discountid}" value=${encodeURI(result.items[i].values.discountmediaid)}>${result.items[i].keys.discountid} - ${result.items[i].values.name}</option>`);
                $("#instore_code_2").append(`<option data-attribute-loyalty="${result.items[i].values.optimainstantwin}" data-attribute-validfrom="${result.items[i].values.datefrom}" data-attribute-validto="${result.items[i].values.dateto}" data-attribute-discountid="${result.items[i].keys.discountid}" value=${encodeURI(result.items[i].values.discountmediaid)}>${result.items[i].keys.discountid} - ${result.items[i].values.name}</option>`);
                $("#instore_code_3").append(`<option data-attribute-loyalty="${result.items[i].values.optimainstantwin}" data-attribute-validfrom="${result.items[i].values.datefrom}" data-attribute-validto="${result.items[i].values.dateto}" data-attribute-discountid="${result.items[i].keys.discountid}" value=${encodeURI(result.items[i].values.discountmediaid)}>${result.items[i].keys.discountid} - ${result.items[i].values.name}</option>`);
                $("#instore_code_4").append(`<option data-attribute-loyalty="${result.items[i].values.optimainstantwin}" data-attribute-validfrom="${result.items[i].values.datefrom}" data-attribute-validto="${result.items[i].values.dateto}" data-attribute-discountid="${result.items[i].keys.discountid}" value=${encodeURI(result.items[i].values.discountmediaid)}>${result.items[i].keys.discountid} - ${result.items[i].values.name}</option>`);
                $("#instore_code_5").append(`<option data-attribute-loyalty="${result.items[i].values.optimainstantwin}" data-attribute-validfrom="${result.items[i].values.datefrom}" data-attribute-validto="${result.items[i].values.dateto}" data-attribute-discountid="${result.items[i].keys.discountid}" value=${encodeURI(result.items[i].values.discountmediaid)}>${result.items[i].keys.discountid} - ${result.items[i].values.name}</option>`);
            }
